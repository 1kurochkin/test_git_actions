...
const issueId = "@ECOMM-2154";
const tmsId = "@C-8629";

describe("Product Description Pages (PDP) Test Suite", function () {
  it(
    "Add multiple 7 days free trial to Cart from PDP " + issueId + " " + tmsId,
    { tags: [TAGS.SMOKE] },
    function () {
      cy.setShopifyCookie();
      basePage.visitPage();
      ...
      cy.addMultipleStreamingMembershipSevenDaysFreeToCartAndValidateIt();
    },
  );
