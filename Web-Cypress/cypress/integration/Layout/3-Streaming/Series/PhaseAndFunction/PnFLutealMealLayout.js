...
describe("Luteal Meals POM Selector Validation Test", function () {
  it("Validates all of the selectors in the Luteal Meals POM", function () {
  ...
  sizes.forEach((size) => {
    it(
      "Responsive - Luteal Meals Page Validation for " +
        size.width +
        ", " +
        size.height,
      function () {
