...
describe("Luteal More About POM Selector Validation Test", function () {
  it("Validates all of the selectors in the Luteal More About POM", function () {
  ...
  sizes.forEach((size) => {
    it(
      "Responsive - Luteal More About Page Validation for " +
        size.width +
        ", " +
        size.height,
      function () {
