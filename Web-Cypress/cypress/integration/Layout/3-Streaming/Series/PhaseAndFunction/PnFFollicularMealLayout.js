...
describe("Follicular Meals POM Selector Validation Test", function () {
  it("Validates all of the selectors in the Follicular Meals POM", function () {
  ...
  sizes.forEach((size) => {
    it(
      "Responsive - Follicular Meals Page Validation for " +
        size.width +
        ", " +
        size.height,
      function () {
