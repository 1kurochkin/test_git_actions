...
describe("Follicular Foods POM Selector Validation Test", function () {
  it("Validates all of the selectors in the Follicular Foods POM", function () {
  ...
  sizes.forEach((size) => {
    it(
      "Responsive - Follicular Foods Page Validation for " +
        size.width +
        ", " +
        size.height,
      function () {
