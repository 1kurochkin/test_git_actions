...
describe("Menstrual Meals POM Selector Validation Test", function () {
  it("Validates all of the selectors in the Menstrual Meals POM", function () {
  ...
  sizes.forEach((size) => {
    it(
      "Responsive - Menstrual Meals Page Validation for " +
        size.width +
        ", " +
        size.height,
      function () {
