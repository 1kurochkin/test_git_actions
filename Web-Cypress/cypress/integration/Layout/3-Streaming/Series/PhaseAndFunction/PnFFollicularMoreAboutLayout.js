...
describe("Follicular More About POM Selector Validation Test", function () {
  it("Validates all of the selectors in the Follicular More About POM", function () {
  ...
  sizes.forEach((size) => {
    it(
      "Responsive - Follicular More About Page Validation for " +
        size.width +
        ", " +
        size.height,
      function () {
