...
describe("Ovulatory Foods POM Selector Validation Test", function () {
  it("Validates all of the selectors in the Ovulatory Foods POM", function () {
    ...
    pnfFoods.getToolTipContentText().scrollIntoView();
    pnfFoods
  ...
  sizes.forEach((size) => {
    it(
      "Responsive - Ovulatory Foods Page Validation for " +
        size.width +
        ", " +
        size.height,
      function () {
