...
describe("Menstrual Foods POM Selector Validation Test", function () {
  it("Validates all of the selectors in the Menstrual Foods POM", function () {
  ...
  sizes.forEach((size) => {
    it(
      "Responsive - Menstrual Foods Page Validation for " +
        size.width +
        ", " +
        size.height,
      function () {
