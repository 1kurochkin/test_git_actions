...
const productURL = "globant-essentials-kit";
const productTitle = "Globant essentials kit + 12 month membership";
const productPrice = "249.99";

describe("Globant Essentials Kit Selector Validation Test", function () {
  it("Validates all of the selectors for the Globant Essentials kit", function () {
